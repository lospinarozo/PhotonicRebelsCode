...
```{r}
# elytra
PolBySpp <- read.csv("./Data/FromCode/PolarzElytraBySpp.csv")[-1]
PolByInd <- read.csv("./Data/FromCode/PolarzElytraByInd.csv")[-1]

# elytra and pronotum
BeetlePol <- read.csv("./Data/FromCode/PolarzElytraPronot.csv")[-1]
```
...
ReflBySpp <- read.csv("./Data/FromCode/ConsolidatedReflectivitySpp.csv")[-1] %>% 
...
```{r}
AbsBySpp <- read.csv("./Data/FromCode/ConsolidatedAbsorptivitySpp.csv")[-1] %>%
  dplyr::arrange(phylogeny_name)
...
source("./Scripts/7_multiple_pgls_function_B.R") # script B is for Polarization as a response
```
...
```{r warning=FALSE, message=FALSE}
source("./Scripts/6_multiple_pgls_function_A.R") # script A is for Polarization as a response
```
...
```{r warning=FALSE, message=FALSE}
source("./Scripts/13_multiple_pgls_function_H.R") # script A is for Polarization as a response
```
...
```{r}
ReflByInd <- read.csv("./Data/FromCode/ConsolidatedReflectivityInd.csv")[-1]

AbsByInd0 <- read.csv("./Data/FromCode/ConsolidatedAbsorptivityInd.csv")[-1]
