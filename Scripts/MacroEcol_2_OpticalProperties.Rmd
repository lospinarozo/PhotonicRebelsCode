...
```{r }
MuPGLSMod0 <- Reflectance ~ VIS
```

Run
 
```{r message= FALSE, warnings=FALSE}
pglsmodFRS <- pgls(NIR ~ VIS,
...
write.csv(Cons1agg,"./Data/FromCode/ConsolidatedReflectivitySpp.csv")
...
```{r}
Cons1A <- read.csv("./Data/FromCode/ConsolidatedAbsoptivityInd.csv")[-1]
```
...
# read the tree
MCCtree.raw <- 
  ape::read.nexus(here("./Data/xmas_mat2b_bst2ef_set23nn2_pinct_med.tre"))
...
write.csv(Cons1aggA,"./Data/FromCode/ConsolidatedAbsorptivitySpp.csv")
```
