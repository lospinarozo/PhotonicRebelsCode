---
title: Absorptivity  without outliers
...
In this script, the response variable is the absorptivity on each spectral band.
...
write.csv(dfTOTA, here::here("Data/FromCode/MuTPglsResultsTOTAbsorptivity_QC.csv"))
...
write.csv(dfVISA, here::here("Data/FromCode/MuTPglsResultsVISAbsorptivity_QC.csv"))
...
write.csv(dfNIRA, here::here("Data/FromCode/MuTPglsResultsNmoAbsorptivity_QC.csv"))
...
write.csv(dfFRSA, here::here("Data/FromCode/MuTPglsFRSultsFRSAbsorptivity_QC.csv"))
...
write.csv(dfPRSA, here::here("Data/FromCode/MuTPglsFRSultsPRSAbsorptivity_QC.csv"))
