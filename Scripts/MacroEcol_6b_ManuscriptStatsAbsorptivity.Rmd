...
source("./Scripts/MacroEcol_1_Libraries.R") # we source the libraries from this file
```
...
```{r}
Cons1aggA <- read.csv("./Data/FromCode/ConsolidatedAbsorptivitySpp.csv")[-1] %>%
  dplyr::arrange(phylogeny_name)
# PC Values
PCValuesF <- read.csv("./Data/FromCode/PCsbySpp.csv")[-1] %>%
  dplyr::arrange(phylogeny_name)
...
```{r warning=FALSE, message=FALSE}
source("./Scripts/8_multiple_pgls_function_C.R") # function C is for absorptivity as response
```
...
```{r warning=FALSE, message=FALSE}
source("./Scripts/9_multiple_pgls_function_D.R") # function D: NIR explained by PCs and VIS
```
...
```{r warning=FALSE, message=FALSE}
source("./Scripts/10_multiple_pgls_function_E.R") # function E: simplified. One PC and size
```
...
```{r warning=FALSE, message=FALSE}
source("./Scripts/11_multiple_pgls_function_F.R") # F: One PC, size and VIS as predictors
```
...
write.csv(dfTOTA,"./Data/FromCode/MuTPglsResultsTOTAbsorptivity.csv")
...
write.csv(dfVISA,"./Data/FromCode/MuTPglsResultsVISAbsorptivity.csv")
...
write.csv(dfNIRA,"./Data/FromCode/MuTPglsResultsNmoAbsorptivity.csv")
...
write.csv(dfFRSA,"./Data/FromCode/MuTPglsFRSultsFRSAbsorptivity.csv")
...
write.csv(dfPRSA,"./Data/FromCode/MuTPglsFRSultsPRSAbsorptivity.csv")
