---
title: Reflectivity PGLS without outliers
...
In this script we repeated the PGLs analysis excluding the outliers: A. prasinus and the species belonging to the genus Xylonichus, Paraschizognathus because these species are known to have an independent mechanism to enhance NIR reflectivity. The main change is the exclusion of these species with "str_detect" in the chunk "Data Sets".
