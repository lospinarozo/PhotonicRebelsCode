---
title: "5_PhylogeneticComparativeAnalysis_Polarization"
...
names(RPDAgg1) <- c("phylogeny_name",
...
```{r}
names(RPDAgg) <- c("TOT", "VIS", "NIR", "Res", "size",
                    "PC1", "PC2", "Pol")
...
p4 <- gheatmap(p4.scale, 
               log(NIRdf+ # get log to bring them closer to each other
