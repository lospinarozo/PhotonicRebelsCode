...
source("./Script/MacroEcol_1_Libraries.R")
```
...
RPDataAggRefl <- read.csv("./Data/FromCode/PolarzElytraRefl.csv")[-1]
head(RPDataAggRefl)
...
RPDAgg1Refl <- as.data.frame(RPDAgg1Refl)
head(RPDAgg1Refl)
names(RPDAgg1Refl) <- c(
  "phylogeny_name",
...
RPDAgg <- as.data.frame(RPDAgg1Refl) # create new data frame
...
Test phylogenetic signal using Pagel's lambda: Pending...
...
Polsubset <-  as.data.frame(Polsubset)
