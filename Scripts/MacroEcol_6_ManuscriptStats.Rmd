...
```{r warning=FALSE, message=FALSE}
source("9_multiple_pgls_function_D.R")# function D: NIR explained by PCs and VIS
```
...
```{r warning=FALSE, message=FALSE}
source("10_multiple_pgls_function_E.R")# function E: simplified. One PC and size
```
...
```{r warning=FALSE, message=FALSE}
source("11_multiple_pgls_function_F.R")# F: One PC, size and VIS as predictors
```
...
write.csv(dfFRS,"../Data/FromCode/MuTPglsResultsFRS.csv")
...
write.csv(dfPRS,"../Data/FromCode/MuTPglsResultsFRS.csv")
