...
These functions will have as arguments: 
...
{tryCatch(
  {
    ...
    rownames(dataset)=dataset$TipLabel #converts the row names into a column
...
Paste the following part of the code in the main file and change the "eval=FALSE" to "eval=TRUE".  

## Source the function

```{r eval=FALSE,warning=FALSE}
source("run_pgls_multiple_trees.Rmd") 
```
...
```{r eval=FALSE}
# Environmental data:
DataFrame= readRDS('environmental.data.file.R')


#Phylogenetic data:
trees= readRDS('1300_trees.rds')
# or
...
pgls_run(trees,# file with multiple trees
         model, # the model we set up earlier
         dataFrame)
